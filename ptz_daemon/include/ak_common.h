...
#define COLOR_MODE_NORMAL        0                                                                  //ȱʡģʽ
#define COLOR_MODE_BOLD          1                                                                  //����
#define COLOR_MODE_UNDERLINED    4                                                                  //�»���
#define COLOR_MODE_BLINK         5                                                                  //��˸
#define COLOR_MODE_NEGATIVE      7                                                                  //��ɫ

#define COLOR_BACK_BLACK         40                                                                 //������ɫ����
